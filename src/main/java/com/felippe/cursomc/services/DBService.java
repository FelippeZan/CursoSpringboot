...
import com.felippe.cursomc.domain.Categoria;
...
import com.felippe.cursomc.domain.ItemPedido;
import com.felippe.cursomc.domain.Pagamento;
import com.felippe.cursomc.domain.PagamentoComBoleto;
import com.felippe.cursomc.domain.PagamentoComCartao;
...
import com.felippe.cursomc.domain.enums.Perfil;
import com.felippe.cursomc.domain.enums.TipoCliente;
import com.felippe.cursomc.repositories.CategoriaRepository;
import com.felippe.cursomc.repositories.CidadeRepository;
import com.felippe.cursomc.repositories.ClienteRepository;
import com.felippe.cursomc.repositories.EnderecoRepository;
...
import com.felippe.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria.silve@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Teste Admin", "teste.admin@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("987654321", "912345678"));
